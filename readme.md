...
- `button.py`, `model3d.py`, `tile.py`, `slider.py` are implementations of classes used by the main code.
...
- Reorganised the drawings around the pivot points (the centers of the 2x2 tiles). As a result, the window size is slightly different.
- Fixed an issue where the rotation animation was slow on slow machines and browsers.
- Added a slider where the user can adjust the animation speed.
- Minor changes in the code.

Version 1.0 (2025.11.24.)

- The first working application.
